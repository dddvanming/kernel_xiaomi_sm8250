...
# Make olddefconfig
cd ${OUT_DIR} || exit
make -j${KEBABS} ${ARGS} CC="clang-r458507/bin/clang" HOSTCC="ccache gcc" HOSTCXX="cache g++" olddefconfig
cd ../ || exit
make -j${KEBABS} ${ARGS} CC="clang-r458507/bin/clang" HOSTCC="ccache gcc" HOSTCXX="ccache g++" 2>&1 | tee build.log
